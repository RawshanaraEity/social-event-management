...
const Footer = () => {
  return (
    <div>
      <footer className="footer grid grid-cols-3 p-10 bg-gray-800 text-white">
  <nav>
...
<footer className="footer flex flex-col md:flex-row justify-center items-center px-10 py-5  bg-gray-900 text-white">
  <aside className="items-center grid-flow-col">
    ...
    <p>Social Events Planner <br/>Providing reliable tech since 2010</p>
  </aside> 
